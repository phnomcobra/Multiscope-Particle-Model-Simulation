...
// 12/11/2013 Updated enumeration with fix for second order
//            integration method
///////////////////////////////////////////////////////////////////////
...
void part::enumerate(const float& tstep)
{
	...
	// Integrate Position from Velocity and Acceleration for the Time Step
	pos = pos + vel * tstep + acc * (.5 * tstep * tstep);
