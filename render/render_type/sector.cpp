...
// 11/30/2013 Fixed type conversion warning on sector::remove
///////////////////////////////////////////////////////////////////////

#include "sector.h"

// Add New Particle
void sector::add(const part& pelt) {pelts.push_back(pelt);}
...
{
	for(unsigned int i = pelti; i < pelts.size() - 1; i++)
	{
		pelts[i] = pelts[i + 1];
	}
	pelts.pop_back();
